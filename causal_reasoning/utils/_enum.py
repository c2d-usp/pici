...
class Examples(Enum):
    ...
    CSV_N7M1="causal_reasoning/data/n7_m1_scaling_case.csv"
    CSV_N8M1="causal_reasoning/data/n8_m1_scaling_case.csv"
    CSV_N9M1="causal_reasoning/data/n9_m1_scaling_case.csv"
    CSV_N10M1="causal_reasoning/data/n10_m1_scaling_case.csv"
    ...
    CSV_N4M4="causal_reasoning/data/n4_m4_scaling_case.csv"
    CSV_N5M4="causal_reasoning/data/n5_m4_scaling_case.csv"
    CSV_N1M6="causal_reasoning/data/n1_m6_scaling_case.csv"
    CSV_N2M6="causal_reasoning/data/n2_m6_scaling_case.csv"
