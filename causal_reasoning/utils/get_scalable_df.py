...
def getScalableDataFrame(M: int, N: int):
    if (N == 1 and M == 1):
        ...
        scalable_csv_path = DataExamplesPaths.CSV_N5M3.value
    elif (N == 1 and M == 4):
        ...
        scalable_csv_path = DataExamplesPaths.CSV_N4M4.value
    elif (N == 5 and M == 4):
        scalable_csv_path = DataExamplesPaths.CSV_N5M4.value
    elif (N == 1 and M == 5):
        ...
        scalable_csv_path = DataExamplesPaths.CSV_N2M6.value
