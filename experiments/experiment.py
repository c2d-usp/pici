...
from experiments.three_latents_scalables.scalable_problem_column_gen import (
    ScalarProblem,
)
...
from experiments.utils.scalable_graphs_helper import find_true_value_in_three_latents_scalable_graphs, generate_three_latents_scalable_string_edges, get_three_latents_scalable_dataframe
...
def lp_call(N_M, intervention_value=1, target_value=1):
    ...
    for values in N_M:
        N, M = values
        scalable_input = generate_three_latents_scalable_string_edges(N, M)
...
def true_value_call(N_M, intervention_value=1, target_value=1):
    for values in N_M:
        ...
        try:
            new_row_df["TRUE_VALUE"] = find_true_value_in_three_latents_scalable_graphs(
